<?php namespace App\Http\Controllers;
	...
	class AdminDataMengajarController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "namapt";
			$this->limit = "20";
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Smt","name"=>"id_smt","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"smt,id"];
			//$this->form[] = ["label"=>"Nm Kls","name"=>"nm_kls","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Kode Mk","name"=>"kode_mk","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Nm Mk","name"=>"nm_mk","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Namapt","name"=>"namapt","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
