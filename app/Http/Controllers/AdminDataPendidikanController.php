<?php namespace App\Http\Controllers;
	...
	class AdminDataPendidikanController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "namajenjang";
			$this->limit = "20";
			...
			$this->table = "data_pendidikan";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Tahun Lulus","name"=>"thn_lulus"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Tahun Lulus','name'=>'thn_lulus','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Thn Lulus","name"=>"thn_lulus","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Nm Sp Formal","name"=>"nm_sp_formal","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Namajenjang","name"=>"namajenjang","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Singkat Gelar","name"=>"singkat_gelar","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
