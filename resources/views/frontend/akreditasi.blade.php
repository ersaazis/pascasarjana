...
@section('content')
        ...
        <div class="container">
            <div class="media-container-row">
                <div class="title col-12 col-md-8">
                    <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-2">AKREDITASI PASCASARJANA <br> UIN Sunan Gunung Djati Bandung</h2>
    ...
    <section class="mt-5 bg-white" id="CariDosen">
        <div class="container">
            <form action="{{url('/akreditasi/')}}" method="GET">
            @csrf
            <div class="input-group">
                <input type="text" placeholder="Judul Akreditasi" value="{{$nama}}" class="form-control" name="Cari">
